...
void *Map_move(void *self, Direction direction){
	...
	//next = location->proto.move(location, directio);
...
int Map_init(void *self){
	...
	// Create some rooms for a small map
//	Room *hall = NEW(Room, "The great Hall");
	Room *hall = Object_new(sizeof(Room), RoomProto, "The great Hall");
	Room *throne = NEW(Room, "The throne room");
	Room *arena = NEW(Room, "The arena, with the minotaur");
	Room *kitchen = NEW(Room, "The kitchen, you have the knife know");
	...
	// start the map and character of in the hall
	map->start = hall;
	map->location = hall;
